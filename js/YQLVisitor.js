...
export default class YQLVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitSelect_stmt_intersect(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitSelect_unparenthesized_stmt_intersect(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by YQLParser#select_kind_parenthesis.
	visitSelect_kind_parenthesis(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitRow_pattern_variable_name(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitGrouping_sets_specification(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by YQLParser#hopping_window_specification.
	visitHopping_window_specification(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitMultiple_column_assignment(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitWindow_name_or_specification(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by YQLParser#window_name.
	visitWindow_name(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitWindow_frame_exclusion(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitOpt_id_prefix_or_type(ctx) {
	  return this.visitChildren(ctx);
	}
